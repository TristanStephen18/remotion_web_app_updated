...
import { KpiFlipCardsImages, serverImages } from "../../data/backgroundimages";
      ...
      >
        ...
        >
          ...
          <Button
            ...
            onClick={() => window.location.assign("/template/kpiflipcards")}
            sx={{
              borderRadius: 2,
              py: 1.2,
              textTransform: "none",
          ...
          {activeSection === "colors" && (
            <Box>
              ...
              >
                ...
                >
                  Choose Font Colors for your Title and Subtitle
                </Typography>
